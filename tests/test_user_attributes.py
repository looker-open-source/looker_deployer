...
def test_get_filtered_user_attributes(mocker):
    user_attribute_list = [
        models.UserAttribute(name="Cheese", id="1", label="Cheese", type="string"),
        models.UserAttribute(name="Sauce", id="2", label="Cheese", type="string")
    ]
...
def test_write_user_attributes_new(mocker):
    user_attribute_list = [
        models.UserAttribute(name="Cheese", id="1", label="Cheese", type="string", is_system=False)
    ]
    ...
    target_sdk.create_user_attribute.assert_called_once_with(
        models.WriteUserAttribute(name="Cheese", label="Cheese", type="string"))
