...
def test_get_filtered_user_attributes_filter(mocker):
    ...
    user_attributes = deploy_user_attributes.get_filtered_user_attributes(sdk, "Cheese")
...
def test_write_user_attributes_new(mocker):
    ...
    user_attribute_group_list = [models.UserAttributeGroupValue(id=1,group_id=1,user_attribute_id=1)]
    ...
    target_sdk.create_user_attribute.assert_called_once_with(models.WriteUserAttribute(name="Cheese"))
...
def test_write_user_attributes_update_group_value(mocker):
    ...
    deploy_user_attributes.write_user_attributes(source_sdk,target_sdk)
    target_sdk.set_user_attribute_group_values.assert_called_once_with(user_attribute_id=1,body=user_attribute_group_list)
